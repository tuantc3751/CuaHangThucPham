		          	...
		          	<div id="mainContent">
		          		<div class="card" style="color: #72777a;">
						  	...
						  	<div class="card-body mx-3 my-2">
		                  		<sf:form class="form" action="/admin/category/edit-save" method="post" modelAttribute="category">
	                        		<div class="form-body">
										<sf:hidden path="id" />
										<!-- id > 0 -> Edit -->
										...
										<div class="row">
		                       		 		<div class="col-md-12">
												<div class="form-group mb-4">
													<button type="submit" class="btn btn-primary btn-color float-end">Save edit category</button>

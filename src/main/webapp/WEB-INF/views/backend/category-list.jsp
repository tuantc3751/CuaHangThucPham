	              			...
	              			<div class="row">
	                			<div class="col-md-12">
	                  				<div class="bgc-white bd bdrs-3 p-20 mB-20">
	                  					...
	                  					<div class="row">
	                  						<div class="col-9">
	                  							<h3 class="c-grey-900 mB-20 d-inline">List Category</h3>
	                  						</div>
	                  						
	                  						<div class="col-3">
	                  							<a href="/admin/category/add" class="btn btn-primary btn-color float-end">Add new category</a>
	                  						</div>
	                  					</div>
						...
						var dataTable = $('#dataTable1').DataTable({
					        ...
					        "columns": [
					            ...
					            { "data": null, "render": function(data, type, row) {
					                return '<div>' + 
					                		'<a href="' + '${resource}/admin/category/edit/' + row.id + '" role="button" class="btn btn-primary me-1" style="display:inline;">Edit</a>' +
					                       	'<a href="' + '${resource}/admin/category/delete/' + row.id + '" role="button" class="btn btn-secondary" style="display:inline;">Delete</a>'+
					            			'</div>'
					            }}
					        ],
					        "scrollX": true,

		        ...
		        <main class="main-content bgc-grey-100">
		          	<div id="mainContent">
		          		<div class="card" style="color: #72777a;">
						  	<h5 class="card-header bg-primary text-white">Edit Product</h5>
		                  		...
		                  		<sf:form class="form" action="${classpath }/admin/product/edit-save" method="post" modelAttribute="product" enctype="multipart/form-data">
	                        		<div class="form-body">
										...
										<div class="row">
	                        		 		<div class="col-md-12">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:textarea path="shortDescription" id="shortDescription" name="shortDescription" class="form-control" rows="3" placeholder="Short desription..."></sf:textarea>
                                        		</div>
	                                    	</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-md-2">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:input path="origin" type="text" class="form-control" id="origin" name="origin" placeholder=""></sf:input>
                                        		</div>
	                                    	</div>
										...
										<div class="row">
		                       		 		<div class="col-md-12">
												<div class="form-group mb-4">
													<button type="submit" class="btn btn-primary btn-color float-end">Save edit product</button>

<div class="sidebar">
        <div class="sidebar-inner">
              ...
              <div class="peer peer-greed">
                <a class="sidebar-link td-n" href="index.html">
                  <div class="peers ai-c fxw-nw">
                    <div class="peer">
                      <div class="logo">
                        <img src="${resource}/backend/assets/static/images/logo.png" alt="">
                      </div>
                    </div>
                    <div class="peer peer-greed">
          ...
          <ul class="sidebar-menu scrollable pos-r">
            ...
            <li class="nav-item">
              <a class="sidebar-link" href="/admin/user/view">
                <span class="icon-holder">
            ...
            <li class="nav-item">
              <a class="sidebar-link" href="/admin/role/view">
                <span class="icon-holder">
                  <i class="bi bi-key"></i>
                </span>
            ...
            <li class="nav-item">
              <a class="sidebar-link" href="/admin/order/view">
                <span class="icon-holder">

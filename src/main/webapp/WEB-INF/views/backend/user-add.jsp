		        ...
		        <main class="main-content bgc-grey-100">
		          	<div id="mainContent">
		          		<div class="card" style="color: #72777a;">
						  	<h5 class="card-header bg-primary text-white">Create User</h5>
						  	<div class="card-body mx-3 my-2">
	                  			<sf:form class="form" action="/admin/user/add-save" method="post" modelAttribute="user" enctype="multipart/form-data">
	                     		 	<div class="form-body">
	                       				<div class="row">
		                       		 		<div class="col-md-6">
		                                   	...
		                                   	<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:input path="password" type="text" class="form-control" id="password" name="password"></sf:input>
		                                      	</div>
		                                   	</div>
										</div>

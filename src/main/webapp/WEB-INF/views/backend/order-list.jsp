	              			...
	              			<div class="row">
	                			<div class="col-md-12">
	                  				<div class="bgc-white bd bdrs-3 p-20 mB-20">
	                   					<div class="row">
	                  						<div class="col-9">
	                  							<h3 class="c-grey-900 mB-20 d-inline">List Order</h3>
	                  						</div>
	                  						
<!-- 	                  						<div class="col-3"> -->
<!-- 	                  							<a href="/admin/order/add" class="btn btn-primary btn-color float-end">Add new order</a> -->
<!-- 	                  						</div> -->
	                  					</div>
	                  					...
	                  					<table id="dataTable1" class="table table-striped table-bordered" cellspacing="0" width="100%">
						                    <thead>
						                        <tr>
						                            ...
						                            <th scope="col">Customer_moblie</th>
					...
					$(document).ready(function() {
						var dataTable = $('#dataTable1').DataTable({
					        ...
					        "columns": [
					            ...
					            { "data": "userCreateSaleOrder" },
					            { "data": "userUpdateSaleOrder" },
					            ...
					            { "data": null, "render": function(data, type, row) {
					                return '<div>' + 
					                		'<a href="' + '${resource}/admin/order/edit/' + row.id + '" role="button" class="btn btn-primary me-1" style="display:inline;">Edit</a>' +
					                       	'<a href="' + '${resource}/admin/order/delete/' + row.id + '" role="button" class="btn btn-secondary" style="display:inline;">Delete</a>'+
					            			'</div>'
					            }}
					        ],
					        "scrollX": true,
...
// 					            },
 					            { "targets": [9,10,11,12], "className": "columnWidth1" },
					          ]
					    });
